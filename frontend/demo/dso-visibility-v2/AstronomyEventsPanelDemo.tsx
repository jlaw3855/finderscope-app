...
import {
  DsoDayDetailsV2,
  DsoTimelineLegendV2,
  DsoVisibilityTimelineV2,
} from '../../src/components/DsoVisibilityTimelineV2'
import {
  PlanetDayDetails,
      ...
      <section className="astronomy-section" aria-labelledby="dso-visibility-heading">
        <div className="dso-section-header">
          ...
          {!dsoLoading && !dsoError && dsoData && (
            <span className="dso-site-sky-chip" data-testid="dso-site-sky-v2">
            ...
            {showTimelineControls && selectedDsoDay && selectedDsoDay.objects.length > 0 && (
              <>
                ...
                <DsoTimelineLegendV2
                  ...
                  darknessSegments={darknessSegments}
                />
                <DsoDayDetailsV2 objects={selectedDsoDay.objects} />
              </>
            )}
