...
function AppDemo() {
  ...
  return (
    <>
      ...
      <div className="app">
        <div
          className="dso-demo-banner dso-demo-banner--v2 panel"
          data-testid="dso-demo-banner-v2"
          role="status"
        >
          Preview: Deep sky visibility visual polish (v2). Loaded after planet visibility. Not yet in
          the main app.
        </div>
