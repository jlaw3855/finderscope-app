...
import type { AstronomyResponse } from '../../src/types/astronomy'
import {
  formatEventCategory,
  formatEventDate,
  ...
  eventCategoryClass,
  sortEventsByStart,
} from '../../src/lib/astronomy-format'
import { formatSiteSky } from '../../src/lib/dso-timeline-layout'
import { darknessSegmentsForCalendarDay } from '../../src/lib/planet-timeline-layout'
import type { DsoVisibilityResponse } from '../../src/types/dso-visibility'
import type { NightForecast, TimeWindow } from '../../src/types/forecast'
import {
  DsoDayDetails,
  DsoTimelineLegend,
  DsoVisibilityTimeline,
} from '../../src/components/DsoVisibilityTimeline'
import {
  PlanetDayDetails,
  PlanetTimelineLegend,
  PlanetVisibilityTimeline,
} from '../../src/components/PlanetVisibilityTimeline'

interface AstronomyEventsPanelDemoProps {
  timezone: string
...
function AstronomyEventsPanelDemoComponent({
  timezone,
  nights,
  priorDayDarkWindow,
  data,
    ...
    <section className="panel astronomy-panel" data-testid="astronomy-panel">
      ...
      <section className="astronomy-section" aria-labelledby="dso-visibility-heading">
        ...
        <p className="muted astronomy-section-note">
          ...
          Loaded after planet visibility so the panel stays responsive.
        </p>
        ...
        {!dsoLoading && !dsoError && dsoData && (
          <>
            <p className="muted dso-site-sky" data-testid="dso-site-sky">
            ...
            {showTimelineControls && selectedDsoDay && selectedDsoDay.objects.length > 0 && (
              <>
                <DsoVisibilityTimeline
                  ...
                  showNextDaySpilloverHint={showNextDaySpilloverHint}
                />
                <DsoTimelineLegend objects={selectedDsoDay.objects} />
...
export const AstronomyEventsPanelDemo = memo(AstronomyEventsPanelDemoComponent)
